...
class PySSC:
	def __init__(self):
		if sys.platform == 'win32' or sys.platform == 'cygwin':
			self.pdll = CDLL("/home/miguel/Desktop/Python_files/SAM examples/Prueba1/ssc.dll") 
		elif sys.platform == 'darwin':
			self.pdll = CDLL("/home/miguel/Desktop/Python_files/SAM examples/Prueba1/ssc.dylib") 
		elif sys.platform == 'linux':
			self.pdll = CDLL('/home/miguel/Desktop/Python_files/SAM examples/Prueba1/ssc.so')   # instead of relative path, require user to have on LD_LIBRARY_PATH
		else:
